  ...
  return (
    <div className="bg-gray-100 min-h-screen py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div data-aos="fade-up-right" className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div data-aos="fade-up-left" className="flex flex-wrap justify-center mb-24 mt-4 bg-white p-6 rounded-lg shadow-md">
